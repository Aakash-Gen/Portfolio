...
function Header(props) {
  ...
  return (
    <div className={`h-14 w-full fixed z-10 top-0 flex justify-between ${props.headerColour} ${props.headerBg} items-center px-24 py-10`}>
        <Link to="home" spy={true} smooth={true} duration={500} offset={-70} className={`hover:cursor-pointer text-[32px] font-semibold ${getUnderlineClass('Home')}`} >Portfolio</Link>
        <div className='flex justify-evenly gap-12 text-[22px] font-medium'>
