...
function Projects() {
    const projects = [
        { title: "Chatblock", description: "Developed a dynamic conversational payments application using React.js and Tailwind CSS, integrating Gemini API for chatbot functionality. Incorporated blockchain transactions through Neucron API and ensured data integrity and security with Firebase." , image:"src/assets/ChatBlock.png",linkUrl:"https://chatblock-bay.vercel.app/login", githubUrl:"https://github.com/Aakash-Gen/chatblock" },
        { title: "Skyzone", description: "Developed a dynamic car showcase and inventory browsing feature using React and Tailwind CSS. Enhanced user experience with intuitive navigation, interactive elements, and detailed car information to aid in purchasing decisions.", image: "src/assets/Skyzone.png",linkUrl:"https://skyzone-steel.vercel.app/", githubUrl:"https://github.com/Aakash-Gen/skyzone" },
