...
function Projects() {
  ...
  return (
    <div id="projects" className="h-full bg-gray-50 pb-20">
        <h1 className="text-[40px] text-gray-600 font-bold pt-36 pb-20 pl-24">My Projects</h1>
...
const boxVariant = {
  ...
  const Box = ({ title, description,image,linkUrl, githubUrl }) => {
    ...
    return (
      <motion.div
        className="box bg-gray-300 p-4 m-4 rounded-3xl shadow-lg w-[650px] h-auto flex flex-col items-center relative group mb-12 "
        ref={ref}
        variants={boxVariant}
        initial="hidden"
        animate={control}
